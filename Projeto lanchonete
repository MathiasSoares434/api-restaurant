Projeto de administração de lanchonete
...
eu ter de fazer várias modificações durante o projeto todo; no HTML houve um equívoco m=de minha parte na utilização do header, onde ficou faltando um dos elementos e tive que usar os id's em ordem diferente, em caso de 
